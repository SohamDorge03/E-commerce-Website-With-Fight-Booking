...
if (isset($_POST['verify'])) {
    ...
    $sql = "SELECT * FROM vendors WHERE username = '$username' AND verify_code = '$enteredCode' AND confirmed_email = 0";
    ...
    if ($result) {
        ...
        if ($rowCount == 1) {
            $updateSql = "UPDATE vendors SET confirmed_email = 1 WHERE username = '$username'";
