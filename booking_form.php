    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Total Price: Rs. ' . $_SESSION['total_amount'] . '</h5>
                        <form action="flight_submit.php" method="post">
                            <script src="https://checkout.stripe.com/checkout.js" class="stripe-button"
                                    data-key="' . $Publishablekey . '"
                                    data-amount="' . $_SESSION['total_amount'] * 100 . '"
                                    data-name="Shopflix"
                            ...
                            <input type="hidden" name="stripeToken" value="' . $_SESSION['u'] . random_int(1000,2000) . '">
                        </form>
                    </div>
                </div>
            </div>
